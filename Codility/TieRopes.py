...
in such a way that the number of ropes whose length is greater than or equal to K is maximal.
...
@pytest.mark.parametrize("K, A, expect", test_case)
def test_solution(K, A, expect):
    res = solution(K, A)
    assert res == expect