...
class MyLinkedList(object):
    ...
    def get(self, index):
        ...
        :rtype: int
        """
        if 0<=index<len(self.mllist):
            return self.mllist[index]
        else:
            return -1
    ...
    def addAtIndex(self, index, val):
        ...
        if index == n:
            ...
            # list.insert
            self.mllist = self.mllist[:index]+[val]+self.mllist[index:]
        return self.mllist
    ...
    def deleteAtIndex(self, index):
        ...
        if 0<=index<len(self.mllist):
            # list.pop(id)
            self.mllist = self.mllist[:index]+self.mllist[index+1:]
        return self.mllist
